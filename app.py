...
def result():
    ...
    try:
        ...
        # 🛡️ Sentinel: Prevent 500 errors by handling invalid or missing user input
        return "Invalid input provided. Please check your form data.", 400
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disable debug mode to prevent interactive debugger and stack trace exposure
