...
def result():
    ...
    try:
        ...
        # 🛡️ Sentinel: Prevent 500 errors and stack trace leakage on bad input
        return "Invalid input data format or missing data", 400
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disabled debug mode to prevent Werkzeug debugger RCE and information disclosure
