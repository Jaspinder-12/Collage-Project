...
def result():
    ...
    try:
        # 🛡️ Sentinel: Wrap input type casting in try-except to prevent unhandled exceptions and 500 errors
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disable debug mode to prevent stack trace leaks
