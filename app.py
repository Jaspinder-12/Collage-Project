...
# Cache for scikit-learn models to prevent expensive disk I/O on every request
model_cache = {}


def get_models():
    """Lazily load and cache models into memory on first request."""
    ...
    return model_cache["sc"], model_cache["model"]
