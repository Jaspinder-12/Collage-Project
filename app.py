...
def result():
    ...
    try:
        ...
        # 🛡️ Sentinel: Prevent 500 errors by handling invalid or missing inputs
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disable debug mode to prevent exposing Werkzeug debugger and internal stack traces
