...
def result():
    try:
        ...
        # 🛡️ Sentinel: Fail securely - prevent 500 errors and stack traces on invalid inputs
        return "Invalid or missing input data. All fields must be valid numbers.", 400
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disabled debug mode to prevent sensitive information leakage via stack traces
