...
# ⚡ Bolt: Cache machine learning models in memory at startup using relative paths
# to prevent synchronous disk I/O and deserialization latency on every request
