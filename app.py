...
def result():
    ...
    try:
        # 🛡️ Sentinel: Encapsulate direct type casting within a try...except block to prevent 500 internal server errors and stack trace leakage.
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disable debug mode to prevent remote code execution and sensitive data leakage via the interactive Werkzeug debugger.
