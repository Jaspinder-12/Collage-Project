...
def result():
    ...
    try:
        ...
        # Sentinel: Avoid internal stack traces on missing or invalid user input
        return jsonify({"error": "Invalid or missing input parameters. Please provide valid numeric values for all fields."}), 400
