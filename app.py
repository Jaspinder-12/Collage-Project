...
def result():
    ...
    try:
        ...
        # 🛡️ Sentinel: Prevent 500 errors and stack trace leakage by validating input format
        return "Invalid input data. Please check your form values.", 400
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disable debug mode to prevent interactive debugger RCE/stack trace exposure
