...
def result():
    ...
    try:
        # 🛡️ Sentinel: Added try-except block to validate user input and prevent unhandled exceptions (500 errors) that could expose stack traces
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disabled debug mode to prevent exposing Werkzeug interactive debugger and internal stack traces
