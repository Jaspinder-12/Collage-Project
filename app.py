...
def result():
    ...
    # 🛡️ Sentinel: Wrap input parsing in try-except to prevent unhandled exceptions and 500 Internal Server Errors from invalid or missing inputs
    try:
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disabled debug mode to prevent exposure of interactive debugger and internal stack traces in production
