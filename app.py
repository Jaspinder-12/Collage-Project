...
model_cache = {"sc": None, "model": None}
...
def result():
    ...
    # Lazy-load and cache the scikit-learn models globally.
    # Deserializing via joblib.load is a heavy, synchronous I/O operation
    # that blocks the thread. Doing it once reduces latency drastically.
    if model_cache["sc"] is None:
