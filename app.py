...
# Cache for lazy-loading models to prevent disk I/O on every request
model_cache = {}
...
def result():
    ...
    return render_template("result.html", prediction=float(Y_pred[0]) if isinstance(Y_pred, (np.ndarray, list)) else float(Y_pred))
