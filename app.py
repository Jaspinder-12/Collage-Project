...
# ⚡ Bolt: Load machine learning models globally at startup to prevent synchronous
# disk I/O and deserialization overhead on every request, significantly improving response latency.
