...
# ⚡ Bolt: Performance Optimization - Cache ML models to prevent disk I/O on every request
_model_cache = {}
...
def result():
    ...
    if "sc" not in _model_cache or "model" not in _model_cache:
        scaler_path = (
        ...
        _model_cache["sc"] = joblib.load(scaler_path)
