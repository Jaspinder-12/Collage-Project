...
def result():
    ...
    # ⚡ Bolt: Performance optimization - Lazy load sc.sav to prevent synchronous I/O on every request
    ...
    # ⚡ Bolt: Performance optimization - Lazy load lr.sav to prevent synchronous I/O on every request
