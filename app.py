...
def result():
    ...
    try:
        ...
        # 🛡️ Sentinel: Prevent 500 Internal Server Error and return 400 Bad Request on invalid input
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disabled debug mode to prevent exposure of internal stack traces and Werkzeug debugger
