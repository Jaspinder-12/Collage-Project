...
def result():
    try:
        ...
        # 🛡️ Sentinel: Security Enhancement - Prevent stack trace leakage on error
        return jsonify({"error": "An error occurred during prediction"}), 400


if __name__ == "__main__":
    # 🛡️ Sentinel: Security Enhancement - Disable debug mode to prevent RCE and stack trace leakage
