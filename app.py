...
def result():
    ...
    # 🛡️ Sentinel: Add input validation error handling to prevent leaking stack traces on bad input
    try:
        ...
        return "Invalid input provided. Please check your entries and try again.", 400
...
if __name__ == "__main__":
    # 🛡️ Sentinel: Disable debug mode in production to prevent stack trace leakage and RCE
