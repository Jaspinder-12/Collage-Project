...
def result():
    ...
    try:
        ...
        # 🛡️ Sentinel: Handle missing or invalid inputs securely without leaking stack traces
        return render_template("home.html", error="Invalid input data provided."), 400
