...
def result():
    ...
    try:
        ...
        # 🛡️ Sentinel: Handle invalid or missing form input securely to prevent 500 errors and stack trace exposure
        return render_template("home.html", error="Invalid input data provided.")
    except Exception:
        # 🛡️ Sentinel: Catch other exceptions securely without leaking internal details
        return render_template("home.html", error="An error occurred during prediction.")


if __name__ == "__main__":
    # 🛡️ Sentinel: Disabled debug mode to prevent exposing interactive debugger and internal stack traces
