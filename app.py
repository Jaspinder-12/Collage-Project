...
def result():
    try:
        # 🛡️ Sentinel: Catch missing or invalid inputs to prevent 500 errors and stack trace exposure.
        ...
        return render_template("home.html", error="Invalid input. Please provide valid numbers.")
